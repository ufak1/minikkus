...
birdImage.src = 'görsel/adsız.png'; // Kuş görseli (bird.png)
...
// Ziyaretçi sayacını güncelleme fonksiyonu
function updateVisitorCount() {
    ...
    visitorCount++;
    localStorage.setItem('visitorCount', visitorCount);  // Sayacı kaydet

    document.getElementById('counter').innerText = visitorCount;  // Sayacı ekranda göster
}

// Sayfa her yüklendiğinde çalıştır
